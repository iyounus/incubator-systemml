...
__all__ = ['MLResults', 'MLContext', 'Script', 'dml', 'pydml', 'dmlFromResource', 'pydmlFromResource', '_java2py',
...
def _matrix_metadata(sc, obj):
    ...
    return sc._jvm.org.apache.sysml.api.mlcontext.MatrixMetadata(fmt, obj._nrow, obj._ncol, obj._nnz)

class MatrixMetadata(object):
    """
    Wrapper around a Java MatrixMetadata object.

    Parameters
    ----------

    """
    def __init__(self, rows, cols, nnz=None, fmt='csv'):
        self._nrow = rows
        self._ncol = cols
        self._nnz = nnz
        self._fmt = fmt
